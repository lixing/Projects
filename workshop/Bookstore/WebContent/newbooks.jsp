...
<title>New Released Books</title>
</head>
<body>
<div id="container">
　　<div id="Header">
...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >New books releasing</font>
    </strong></font></td>
</table>
<%
		...
		ResultSet result= sta.executeQuery("select isbn, title, author, price, cover" 
				                            +" from books where new= 1 and post =1 order by isbn asc");       
while(result.next()){
%>
