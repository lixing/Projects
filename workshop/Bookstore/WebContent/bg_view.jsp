...
try{
	...
	r1= sta.executeQuery("select isbn, title, author, price, cover, number, booktype, new, post from books order by booktype asc"  );
	%> 
...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >All the books are listed here</font>
    </strong></font></td>
</table>
		...
		<td width="70"><div align="center" ><b>Store account</b></div></td>
		<td width="70"><div align="center" ><b>book type</b></div></td>
		<td width="70"><div align="center" ><b>new</b></div></td>
		<td width="70"><div align="center" ><b>post</b></div></td>
		</tr>
<% 	
	while(r1.next()){
		String type= null;
...
%>	
		...
		<td width="70"><div align="center" class="style1"><%=type%></div></td>
		<td width="70"><div align="center" class="style1"><%=newold%></div></td>
		<td width="70"><div align="center" class="style1"><%=posted%></div></td>
		</tr>
		<%} %>
    </table>	
<br><br><br><br>
