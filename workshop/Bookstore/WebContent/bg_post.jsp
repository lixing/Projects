...
try{
	...
	r1= sta.executeQuery("select isbn, title, author, price, cover, number, booktype, new, post from books where post =1"  );
	%>
...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >You can drop/post books here</font>
    </strong></font></td>
</table>
	    <h3>&nbsp; &nbsp; &nbsp; &nbsp;Here are the posted books </h3>
...
%>	
		...
		<td width="60"><div align="center" class="style1"><img src="./images/bg/control.jpg "onClick="location.href='bg_dropok.jsp?isbn=<%=r1.getLong(1)%>'" /><br>Drop</div></td>
		</tr>
		<%} %>
    </table>	
 ...
 <%	
	...
	r2= sta.executeQuery("select isbn, title, author, price, cover, number, booktype, new, post from books where post =0"  );
	%>
	    <h3>&nbsp; &nbsp; &nbsp; &nbsp;Here are the non posted books </h3>
	    <table width="800" border="0" align="center">
 		<tr bgcolor="#D9E7FF">
 		<td height="20" width="80"><div align="center" ><b>Book Front</b></div></td>
		<td width="80"><div align="center" ><b>ISBN</b></div></td>
...
%>	
        ...
        <td width="60"><div align="center" class="style1"><img src="./images/bg/control.jpg "onClick="location.href='bg_postok.jsp?isbn=<%=r2.getLong(1)%>'" /><br>Post</div></td>
		</tr>
		<%} %>
    </table>	
