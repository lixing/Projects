...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >First please upload the book front</font>
    </strong></font></td>
</table>
 <form action="bg_add.jsp" method="post" enctype="multipart/form-data" name="form1">
