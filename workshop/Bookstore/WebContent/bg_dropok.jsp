...
<title>Drop books successfully</title>
</head>
<body>
<div id="container">
　　<div id="Header">
...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >Drop book successfully!</font>
    </strong></font></td>
</table>
		<%
  ...
  sta.executeUpdate
  ("UPDATE books SET post = 0 where isbn='"+isbn+"'");
  sta.close();
  conn.close();
...
<br><br><br><br>
<table align ="center">
<tr><td><p align="center"><img src="./images/bg/spost.jpg "onClick="location.href='bg_post.jsp'" /><font size="4px">Back to Post/Drop&nbsp; &nbsp; &nbsp;</font></p></td> 
