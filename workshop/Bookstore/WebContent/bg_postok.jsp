...
<title>Post books successfully</title>
</head>
<body>
<div id="container">
　　<div id="Header">
...
<tr bgcolor="#A60000">
    <td width="600" align="center" bgcolor="#A60000"><font size="5px"><strong><font color=white >Post book successfully!</font>
    </strong></font></td>
</table>
		<%
  ...
  sta.executeUpdate
  ("UPDATE books SET post = 1 where isbn='"+isbn+"'");
  sta.close();
  conn.close();
