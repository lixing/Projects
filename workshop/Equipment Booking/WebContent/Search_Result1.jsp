...
rs = consql.SearchEquipment(equipment);
%>
<center>
<form>
...
<%if(a.equalsIgnoreCase("1")){ %><input type="submit" name="searchresults" id="searchresults" value="OK" style="width:80px;height:30px;font-size:15px;"/>
