...
#ifndef __pqueue_cs106__
#define __pqueue_cs106__
 ...
 */
	...
	static string typeToName(PQueueType type);
 ...
 * implementation, can track their logical size using the logSize
 ...
 * exists at this level, and that the subclasses should be required
 * to provide an implementation.
 */
	
	virtual void enqueue(string elem) = 0;
